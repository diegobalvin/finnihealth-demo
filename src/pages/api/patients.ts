...
export default async function handler(
  ...
  if (req.method === 'GET') {
    ...
    const patients: Patient[] = (data as PatientRow[]).map(mapPatientRow);
    ...
    res.status(200).json({
      ...
      patients: [],
      patient: mapPatientRow(updatedPatient as PatientRow),
    });
    ...
    res.status(200).json({
      ...
      patients: [],
      patient: mapPatientRow(deletedPatient as PatientRow),
    });
  } else {
